...
public class PastMeetingImpl extends MeetingImpl implements PastMeeting,
	...
	private static final long serialVersionUID = 2491285021250525977L;
	private String note;

	/**
	 * Returns the notes from the meeting. If there are no notes, the empty
	 * string is returned. return "Meeting ID: "+getId()+" "
	 * +"\nMeeting Date: "+
